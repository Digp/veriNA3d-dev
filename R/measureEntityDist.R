...
#' entities. This function is a wrapper of [measureElenoDist()] and simplifies
#' its use. If you are unfamiliar with the concept of entities in a mmCIF
...
#' @param ... Additional arguments to be passed to [measureElenoDist()]
#'
